...
const (
	...
	SessionAPI   string = "https://battlefield-api.sakurakooi.cyou/account/login" // SessionAPI 通过SakuraKooi 获取session 信息
...
const (
	...
	ServerDetals string = "GameServer.getFullServerDetails"    // ServerDetails	单服务器完整信息查询
