	...
	"RT_VERSION": {
	  "#1": {
		"0000": {
		  ...
		  "info": {
			"0409": {
			  "Comments": "OneBot plugin based on ZeroBot",
			  "CompanyName": "FloatTech",
			  "FileDescription": "https://github.com/KomeiDiSanXian/BFHelper",
			  "FileVersion": "%s",
			  "InternalName": "",
			  "LegalCopyright": "%s",
			  "LegalTrademarks": "",
			  "OriginalFilename": "BFHelper.exe",
			  "PrivateBuild": "",
			  "ProductName": "BFHelper",
			  "ProductVersion": "%s",
			  "SpecialBuild": ""
			}
		  }
...
func main() {
	...
	_, err = fmt.Fprintf(f, json, fv, fv, banner.Version, time.Now().Format(timeformat), fv, banner.Copyright+". All Rights Reserved.", banner.Version)
	if err != nil {
		panic(err)
	}
}